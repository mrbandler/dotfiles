  ...
  den.aspects.desktop-dms = {
    ...
    homeManager = { lib, ... }: {
      ...
      programs.dank-material-shell = {
        ...
        niri = {
          enableSpawn = true;
          includes = { enable = true; override = true; originalFileName = "hm"; };
        };
        ...
        settings = {
          ...
          lockScreenActiveMonitor = lib.mkDefault "DP-1";
          lockScreenInactiveColor = "#0f0f17";
          lockScreenNotificationMode = 1;
          osdAlwaysShowValue = true;
          powerMenuDefaultAction = "lock";
          niriOutputSettings = lib.mkDefault {
            DP-1 = { focusAtStartup = true; layout = null; };
          };
          displayProfiles = lib.mkDefault {
            niri.default = {
          ...
          activeDisplayProfile = lib.mkDefault { niri = "default"; };
